    ...
    "paths": {
        ...
        "/api/trash": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "boolean",
                        "description": "Admin only: list all users' trash items",
                        "name": "all",
                        "in": "query"
                    }
                ],
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/http.TrashItemResponse"
                            }
                        }
                    }
                }
            ...
            "delete": {
                ...
                "parameters": [
                    {
                        "description": "IDs of trash items to permanently delete",
                        "name": "ids",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/http.TrashDeleteRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/trash/move": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Items to move to trash",
                        "name": "items",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/http.TrashMoveRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/trash/restore": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "IDs of trash items to restore",
                        "name": "ids",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/http.TrashRestoreRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "http.TrashItemResponse": {
            ...
            "properties": {
                ...
                "username": {
                    "description": "only shown to admin",
                    "type": "string"
                }
            }
        },
        "http.TrashMoveItem": {
            ...
            "properties": {
                "path": {
                    "description": "full index path (including user scope)",
                    "type": "string"
                },
                "source": {
                    "type": "string"
        ...
        "http.TrashMoveRequest": {
            "type": "object",
            "properties": {
                "items": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/http.TrashMoveItem"
                    }
                }
            }
        },
        "http.TrashRestoreRequest": {
            "type": "object",
            "properties": {
                "ids": {
                    "type": "array",
